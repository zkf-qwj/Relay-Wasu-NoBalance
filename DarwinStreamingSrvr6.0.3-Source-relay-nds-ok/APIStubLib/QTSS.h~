...
enum 
{
    ...
    qtssWriteFlagsIsMpeg2           = 0x00000010
};
...
enum
{
    ...
    qtssPrefsProtocolLogFileName		    = 90,   // "protocol log file name char array
	qtssPrefsProtocolLogEnable		    	= 91,   // "protocol log enable/ true/false     
	qtssPrefsDataBaseUrl                    = 92,   // database url like memcached
	qtssPrefsNumUDPPorts                    = 93,   //the size of udp_ports_pool
	qtssPrefsMINUDPPort                     = 94,   //the min port of udp_ports_pool
	qtssPrefsBindUDPPortsIPAddr             = 95,   // the given ip addr for udp ports pool

    qtssPrefsNumParams                      = 96
};
...
QTSS_Error  QTSS_Enable_DiffServ(QTSS_StreamRef inRef, UInt8 TOS);
