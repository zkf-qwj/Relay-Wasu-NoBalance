...
class ReflectorSession
{
    public:
        ...
        QTSS_Error      SetupReflectorSession(SourceInfo* inInfo, QTSS_StandardRTSP_Params* inParams,
                                                UInt32 inFlags = kMarkSetup, Bool16 filterState = true, UInt32 filterTimeout = 30, ARTSRelayInfo* fartsRelayInfo=NULL);
        ...
        Bool16          fStartStoreTask;
        Bool16      fStartSourceThread;
        ARTSRelayInfo *fARTSRelayInfo; 
