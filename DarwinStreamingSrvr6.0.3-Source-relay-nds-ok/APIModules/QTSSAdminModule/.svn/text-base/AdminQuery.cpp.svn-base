...
{   /* fAttrName, len, id, fDataptr*/
    { "modules",   (UInt32) strlen("modules"),      eModuleID,  NULL    },
    { "admin",     (UInt32) strlen("admin"),        eRootID,    NULL    },
    { "URL",       (UInt32) strlen("URL"),          eURL,       NULL    },
    { "QUERY",     (UInt32) strlen("QUERY"),        eQuery,     NULL    },
    { "parameters",(UInt32) strlen("parameters"),   eParameters,NULL    },
    { "snapshot",  (UInt32) strlen("snapshot"),     eSnapshot,  NULL    },
    { "command",   (UInt32) strlen("command"),      eCommand,   NULL    },
    { "value",     (UInt32) strlen("value"),        eValue,     NULL    },
    { "type",      (UInt32) strlen("type"),         eType,      NULL    },
    { "access",    (UInt32) strlen("access"),       eAccess,    NULL    },
    { "name",      (UInt32) strlen("name"),         eName,      NULL    },
    { "filter1",   (UInt32) strlen("filter1"),      eFilter1,   NULL    },
    { "filter2",   (UInt32) strlen("filter2"),      eFilter2,   NULL    },
    { "filter3",   (UInt32) strlen("filter3"),      eFilter3,   NULL    },
    { "filter4",   (UInt32) strlen("filter4"),      eFilter4,   NULL    },
    { "filter5",   (UInt32) strlen("filter5"),      eFilter5,   NULL    },
    { "filter6",   (UInt32) strlen("filter6"),      eFilter6,   NULL    },
    { "filter7",   (UInt32) strlen("filter7"),      eFilter7,   NULL    },
    { "filter8",   (UInt32) strlen("filter8"),      eFilter8,   NULL    },
    { "filter9",   (UInt32) strlen("filter9"),      eFilter9,   NULL    },
    { "filter10",  (UInt32) strlen("filter10"),     eFilter10,  NULL    },
    { "",   0,      -1,     NULL    }
};
