...
void StrPtrLen::PrintStr(FILE *file)
{
...
void StrPtrLen::PrintStrEOL(char* stopStr, char *appendStr, FILE *file)
{
    ...
    {   
        ...
        { 
        	if(file)
        	{
				qtss_fprintf(file,theStrLine);
	        	qtss_fprintf(file,theChar);
        	}
			else
			{			
