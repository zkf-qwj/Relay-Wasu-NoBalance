...
class QTSServerPrefs : public QTSSPrefs
{
    public:
        ...
        UInt32  GetWindowSizeThreshold()        { return fWindowSizeThreshold; }
		 ...
		 Bool16  IsProtocolLogEnabled()          { return fProtocolLogEnabled; }
        //
        ...
        char*   GetProtocolLogFileName()
            { return this->GetStringPref(qtssPrefsProtocolLogFileName); }			
        ...
        UInt32 GetNumUDOPPorts()                    {return  fNumUDPPorts; }
        UInt32 GetMinUDPPort()                      { return fMinUDPPort;}
