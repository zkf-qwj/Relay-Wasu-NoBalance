...
class RTPBandwidthTracker
{
    public:
        ...
        SInt32              GetAvgCongestionWindowSize()    { return fNumStatsSamples? (SInt32)(fTotalCongestionWindowSize / (SInt64)fNumStatsSamples) : 0; }
        SInt32              GetMaxRTO()                     { return fMaxRTO; }
        SInt32              GetMinRTO()                     { return fMinRTO; }
        SInt32              GetAvgRTO()                     { return fNumStatsSamples? (SInt32)(fTotalRTO / (SInt64)fNumStatsSamples) : 0; }
