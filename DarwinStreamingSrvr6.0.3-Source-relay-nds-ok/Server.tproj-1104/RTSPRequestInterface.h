...
class RTSPRequestInterface : public QTSSDictionary
{
    public:
        ...
        void    WriteContext(StrPtrLen *str);
        // MODIFIERS
        ...
        QTSS_RTSPMethod             SetMethod(int method)   { fMethod = method;}
        ...
        void       					SetTransportType(QTSS_RTPTransportType trasportType)  {fTransportType = trasportType; }		
		...
		Bool16                      GetIsMPEG2()                { return  isMPEG2; }
		Bool16                      GetIsIpqam()                { return isIpqam; } 
		void                        SetNoDescribe()             {noDescribe= true;}
		//Bool16                      SetSupportOtherChannel(Bool16 flags) { supportOtherChannel =flags;}
		
		UInt32						GetContentType()			{ return fContentType; }
        UInt32                      SetContentType( UInt32  type)            { fContentType = type;}
    ...
    protected:
        ...
        enum
        {
            kMovieFolderBufSizeInBytes = 512,   //Uint32
            kMaxFilePathSizeInBytes = 512       //Uint32
        };
