...
enum
  {
      qtssSDPType      = 0, //Content-Type: application/sdp
      qtssRTSPMHType   =1,   //Content-Type: application/x-rtsp-mh
      qtssNumContentType   =2,
      qtssIllegalContentType =2
  };
...
enum
{
    ...
    qtssRecordMethod        = 10,
    qtssValidateMethod      = 11,
    qtssPingMethod          = 12,
    
    qtssNumMethods          = 13,
    qtssIllegalMethod       = 13
...
enum
{
	...
	qtssPlayWithinSetup         = 62,
    qtssXWapProfileHeader       = 63,
    qtssXWapProfileDiffHeader   = 64,
    qtssXregionIDHeader         = 65,
    qtssXNotice                 = 66,
    qtssXPositionHeader         = 67,
    qtssXTSInfoHeader           = 68,
     qtssClientSessionId         = 69,
    qtssOnDemandSessionId       = 70,
	
	qtssNumHeaders				= 71,
	qtssIllegalHeader 			= 71	
