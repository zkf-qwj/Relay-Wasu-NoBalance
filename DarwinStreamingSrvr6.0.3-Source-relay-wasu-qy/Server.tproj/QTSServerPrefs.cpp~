...
QTSServerPrefs::PrefInfo QTSServerPrefs::sPrefInfo[] =
{
    ...
    { kDontAllowMultipleValues, "Protocol",    NULL                 },  //protocol_log_file_name
    { kDontAllowMultipleValues, "false",     NULL                   },  //protocol_log_enable
    { kAllowMultipleValues,     "",          NULL                   },  // database_url
    {kDontAllowMultipleValues,  "0",         NULL                   },  // the size of udp ports pool
    {kDontAllowMultipleValues,  "0",         NULL                   }  // the min port of  udp ports pool
};
...
{   /*fields:   fAttrName, fFuncPtr, fAttrDataType, fAttrPermission */
    ...
    /* 90 */ { "protocol_log_file_name",                    NULL,               qtssAttrDataTypeCharArray,  qtssAttrModeRead | qtssAttrModeWrite },
    /* 91 */ { "protocol_log_enable",                       NULL,               qtssAttrDataTypeBool16,     qtssAttrModeRead | qtssAttrModeWrite },
    /* 92 */ { "database_url",                    NULL,                         qtssAttrDataTypeCharArray,  qtssAttrModeRead | qtssAttrModeWrite },
    /* 93 */ { "udp_ports_pool_num",                    NULL,                   qtssAttrDataTypeUInt32,     qtssAttrModeRead | qtssAttrModeWrite },
    /* 94 */ { "min_udp_port",                    NULL,                         qtssAttrDataTypeUInt32,     qtssAttrModeRead | qtssAttrModeWrite },
    /* 95 */ { "bind_ip_addr_for_udp_pool",                    NULL,            qtssAttrDataTypeCharArray,  qtssAttrModeRead | qtssAttrModeWrite }
...
void QTSServerPrefs::SetupAttributes()
{
    ...
    this->SetVal(qtssPrefs3GPPTargetTime,               &f3GPPRateAdaptTargetTime,      sizeof(f3GPPRateAdaptTargetTime));
 	...
 	this->SetVal(qtssPrefsProtocolLogEnable,       		&fProtocolLogEnabled,       	sizeof(fProtocolLogEnabled));    
 	this->SetVal(qtssPrefsNumUDPPorts,               &fNumUDPPorts,               sizeof(fNumUDPPorts));
 	 this->SetVal(qtssPrefsMINUDPPort,               &fMinUDPPort,               sizeof(fMinUDPPort));
