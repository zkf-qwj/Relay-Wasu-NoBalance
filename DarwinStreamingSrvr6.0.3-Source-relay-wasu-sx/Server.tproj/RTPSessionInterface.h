...
class RTPSessionInterface : public QTSSDictionary, public Task
{
    public:
        ...
        void    SetRTSPTimeout(SInt64 timeOutInMS) { if(fRTSPSession != NULL) fRTSPSession->SetTimeOut(timeOutInMS);}
        void    SetTimeOuts(SInt64 timeOutInMS)   {SetTimeOut(timeOutInMS);SetRTSPTimeout(timeOutInMS);}
        //
        // ACCESSORS
